    ...
    <View style={styles.container}>
      ...
      <View style={styles.divHeaderLivro}>
        <View style={styles.BackgroundLivro}>
          <Image source={require("@/assets/images/img/livro1.png")} style={{width:"auto", height:"90%", margin: 8}}></Image>
        </View>
      ...
      <View style={styles.comentarioInputContainer}>
        <TextInput style={styles.comentarioInput} placeholder="Deixe seu comentário"></TextInput>
        <TouchableOpacity >
          <Text style={styles.postarComentario}>
            Postar
          </Text>
        </TouchableOpacity>
      </View>
      <View style={styles.divComentario}>
        <Text style={styles.dadosComentario}>Gabriel Marcos  •  02 Fevereiro, 2022</Text>
